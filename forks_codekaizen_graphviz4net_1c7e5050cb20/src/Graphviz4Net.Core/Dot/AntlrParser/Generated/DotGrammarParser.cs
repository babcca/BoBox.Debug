...
// $ANTLR 3.3.1.7705 ./Dot/AntlrParser/DotGrammar.g 2012-02-08 17:29:42
...
public partial class DotGrammarParser : Antlr.Runtime.Parser
{
	...
	// $ANTLR start "dot"
	// ./Dot/AntlrParser/DotGrammar.g:29:8: public dot : GRAPH opt_id L_CURL_BRACKET stmt_list R_CURL_BRACKET ;
	[GrammarRule("dot")]
	public void dot()
	{
		EnterRule_dot();
		...
		try
		{
			// ./Dot/AntlrParser/DotGrammar.g:29:11: ( GRAPH opt_id L_CURL_BRACKET stmt_list R_CURL_BRACKET )
			DebugEnterAlt(1);
			// ./Dot/AntlrParser/DotGrammar.g:29:13: GRAPH opt_id L_CURL_BRACKET stmt_list R_CURL_BRACKET
			{
			DebugLocation(29, 13);
	...
	private static class Follow
	{
		...
		public static readonly BitSet _subgraph_stmt_in_stmt_list163 = new BitSet(new ulong[]{0x14010120800UL});
		public static readonly BitSet _stmt_list_in_stmt_list165 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _stmt_in_stmt_list171 = new BitSet(new ulong[]{0x4000000000UL});
		public static readonly BitSet _SEMICOLON_in_stmt_list173 = new BitSet(new ulong[]{0x14010120800UL});
		public static readonly BitSet _stmt_list_in_stmt_list175 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _GRAPH_in_stmt191 = new BitSet(new ulong[]{0x2000000UL});
		public static readonly BitSet _opt_attr_list_in_stmt197 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _id_in_stmt208 = new BitSet(new ulong[]{0x2000000UL});
		public static readonly BitSet _opt_attr_list_in_stmt214 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _id_in_stmt225 = new BitSet(new ulong[]{0x3000UL});
		public static readonly BitSet _set_in_stmt227 = new BitSet(new ulong[]{0x100000UL});
		public static readonly BitSet _id_in_stmt237 = new BitSet(new ulong[]{0x2000000UL});
		public static readonly BitSet _opt_attr_list_in_stmt243 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _NODE_in_stmt253 = new BitSet(new ulong[]{0x2000000UL});
		public static readonly BitSet _opt_attr_list_in_stmt255 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _EDGE_in_stmt260 = new BitSet(new ulong[]{0x2000000UL});
		public static readonly BitSet _opt_attr_list_in_stmt262 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _SUBGRAPH_in_subgraph_stmt276 = new BitSet(new ulong[]{0x100000UL});
		public static readonly BitSet _id_in_subgraph_stmt282 = new BitSet(new ulong[]{0x1000000UL});
		public static readonly BitSet _L_CURL_BRACKET_in_subgraph_stmt286 = new BitSet(new ulong[]{0x14810120800UL});
		public static readonly BitSet _stmt_list_in_subgraph_stmt288 = new BitSet(new ulong[]{0x800000000UL});
		public static readonly BitSet _R_CURL_BRACKET_in_subgraph_stmt290 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _L_SQUARE_BRACKET_in_opt_attr_list305 = new BitSet(new ulong[]{0x100000UL});
		public static readonly BitSet _attr_list_in_opt_attr_list311 = new BitSet(new ulong[]{0x1000000000UL});
		public static readonly BitSet _R_SQUARE_BRACKET_in_opt_attr_list313 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _L_SQUARE_BRACKET_in_opt_attr_list322 = new BitSet(new ulong[]{0x1000000000UL});
		public static readonly BitSet _R_SQUARE_BRACKET_in_opt_attr_list324 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _attr_in_attr_list356 = new BitSet(new ulong[]{0x102UL});
		public static readonly BitSet _COMMA_in_attr_list364 = new BitSet(new ulong[]{0x100000UL});
		public static readonly BitSet _attr_in_attr_list370 = new BitSet(new ulong[]{0x102UL});
		public static readonly BitSet _id_in_attr391 = new BitSet(new ulong[]{0x4000UL});
		public static readonly BitSet _EQUALS_in_attr393 = new BitSet(new ulong[]{0x200100000UL});
